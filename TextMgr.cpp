...
CTextMgr::CTextMgr() : m_pFont(NULL), m_pName(NULL), m_pAlarm(NULL), m_pTimeFont(NULL), MAXTIME(80.0f), m_pNotice(NULL)
{
}
...
void CTextMgr::Render(RECT name, RECT info, UI_SPELLTYPE type)
{
	RECT rc;
