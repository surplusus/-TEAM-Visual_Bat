...
{
	RenderBlankGauge(m_vecMultiVertex, m_stInfo.vPos.y + 3.5f, D3DXVECTOR3(3.0f, 0.2f, 1.0f));
	RenderCellGauge( m_vecMultiVertex, m_stInfo.vPos.y + 3.5f,  D3DXVECTOR3(3.0f, 0.2f, 1.0f), m_fDmg);
}
