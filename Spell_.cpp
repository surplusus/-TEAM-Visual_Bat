...
void CSpell_::Initialize()
{
	...
	cout << m_ImageLoader->GetImageInfo().Width << endl;
	cout << m_ImageLoader->GetImageInfo().Height << endl;
	cout << m_ImageLoader->GetImageInfo().Width * m_vScale.x << endl;
	cout << m_ImageLoader->GetImageInfo().Height * m_vScale.y << endl;
	cout << endl;
